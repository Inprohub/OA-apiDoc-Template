...
$(function () {
    ...
    var main = {
        ...
        render: function (obj) {
            ...
            main.$tabs = $(main.$tabs.map(function (t) {
                return $('<a />').attr('data-name', t.v).text(t.title).click(function () {
            ...
            main.$panels = $(main.$panels.map(function (t) {
                ...
                for (var field in t.fields)
                    fields.push($.extend(t.fields[field], {
                        title: t.d4 == field ? '' : field
                    }));
                ...
                $div.append(t.examples.map(function (u) {
                    var $pre = $('<pre />').addClass('language-' + u.type).addClass('prettyprint').addClass('language-javascript').text(u.content);
    ...
    var menu = {
        ...
        init: function () {
            ...
            menu.$el.append($('<footer />').attr('id', 'footer').text('GF後台2.0專案').append($('<a />').attr('href', 'http://bo.rc.goldenf.ai/').attr('target', '_blank').text('網站')));
        ...
        filter: function (q) {
            ...
            menu.$links = $(menu.$links.length ? menu.$links.reduce(function (p, n) {
                return p.concat(n);
            }) : []).map($.fn.toArray);
